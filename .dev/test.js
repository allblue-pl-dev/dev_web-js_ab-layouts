...
abFSWatcher.watch('c:\\SfTd\\AllBlue\\Development\\WebJS_Spocky\\git\\dev_web-js_ab-layouts\\dev\\site', [ 'add', 'unlink', 'change' ], (fsPath, eventType) => {
    console.log('Test: ', fsPath, eventType);
});
